...
$encryptMagic = array(0x15, 0x36, 0x58); //Replace these magic numbers for security measure! Use at least three of them!
$enableEmail = false; //Xjtfen
if ($enableEmail){
	...
	$smtprplyaddr = "example@outlook.com";
	$smtpmailsubject = "Email验证通知邮件";
	$smtpmailcontent = <<<EOF
<h1>验证方式</h1><h2>Email验证通知邮件</h2><hr><br><p>{{USER_NAME}}: </p><p style='text-indent:2em'>欢迎您注册！</p>
...
<p>顺颂时祺</p>
<p align='right'>验证中......</p><p align='right'>{{SEND_DATE}}</p>
EOF;
...
if (basename(__FILE__) == basename($_SERVER["SCRIPT_FILENAME"])) {
	...
	<?php		
			...
			case "reg":
				...
				file_put_contents(dirname(__FILE__)."/".str_replace("@",".",$data[0])."/welcome.txt", "Welcome to Sign Up Test Page");
